<template>              
    <li class="ml-10 border-pink-600">          
        ...
        <div class="flex flex-col items-start justify-between px-4 py-2 bg-white">
            ...
            <div class="flex flex-col p-3 my-2 w-full text-xs italic font-normal text-gray-500 border border-black rounded-lg ">
                <Disclosure 
                    title="Technologies"
                    :headerClass="'font-normal text-gray-600 border-transparent !p-0'"
                    :headerContent="'font-normal !p-0 !px-1'"
                    :items="technologies"
                />
                <Disclosure 
